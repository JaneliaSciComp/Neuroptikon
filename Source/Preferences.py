...
class Preferences( wx.Frame ):
    ...
    def __init__(self, parent=None):
        wx.Frame.__init__(self, parent, -1, "Preferences", size=(200,300), pos=(-1,-1))
        
        # Build the UI
        config = wx.Config("Neuroptikon")
        backgroundColor = wx.Color(config.ReadFloat("Color/Background/Red", 0.7) * 255, config.ReadFloat("Color/Background/Green", 0.8) * 255, config.ReadFloat("Color/Background/Blue", 0.7) * 255)
        ...
        colorBox.Add(wx.StaticText(self, -1, "Background Color:"), 0, wx.EXPAND)
