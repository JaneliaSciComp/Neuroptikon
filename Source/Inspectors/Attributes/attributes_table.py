    ...
    def SetValue(self, row, col, value):
        ...
        if col == 0:
            ...
            try:
                ...
                wx.MessageBox(str(exceptionValue) + ' (' + exceptionType.__name__ + ')', gettext('Could not set the value of the attribute:'), parent = self.gridRef().GetTopLevelParent(), style = wx.ICON_ERROR | wx.OK)
