...
#centralities = networkx.closeness_centrality(network.graph, weighted_edges = True, progress_callback = progressCallback)
centralities = networkx.betweenness_centrality(network.graph, weighted_edges = True, progress_callback = progressCallback)
#centralities = networkx.load_centrality(network.graph, weighted_edges = True, progress_callback = progressCallback)
