...
display.setLabelPosition(protocerebralBridge, (0.0, 0.5, 0.0))
...
display.setLabelPosition(fanShapedBody, (0.0, 0.5, 0.0))
...
display.setVisibleSize(ellipsoidBody, (0.2, 0.4, 0.075))
display.setVisibleShape(ellipsoidBody, shapes['Capsule'](interiorIncludesCaps = True))
display.setLabel(ellipsoidBody, ellipsoidBody.name)
anteriorEB = network.createRegion(name = 'Anterior EB', abbreviation = 'Anterior', parentRegion = ellipsoidBody)
display.setArrangedAxis(anteriorEB, None)
display.setVisibleShape(anteriorEB, None)
display.setVisiblePosition(anteriorEB, (0.0, 0.3, 0.0), fixed = True)
display.setVisibleSize(anteriorEB, (1.3, 0.5, 0.75))
outerAntEB = network.createRegion(name = 'Ellipsoid body anterior outer ring', abbreviation = 'Outer', parentRegion = anteriorEB)
regions['EB-ant-out'] = outerAntEB
display.setVisiblePosition(outerAntEB, (0.0, 0.0, 0.0), fixed = True)
display.setVisibleSize(outerAntEB, (1.0, 1.0, 1.0), fixed = True)
display.setVisibleShape(outerAntEB, shapes['Ring'](holeSize = 3.25 / 5.0))
display.setLabelPosition(outerAntEB, (0.0, 0.4, 0.0))
innerAntEB = network.createRegion(name = 'Ellipsoid body anterior inner ring', abbreviation = 'Inner', parentRegion = anteriorEB)
regions['EB-ant-in'] = innerAntEB
display.setVisiblePosition(innerAntEB, (0.0, 0.0, 0.0), fixed = True)
display.setVisibleSize(innerAntEB, (2.75 / 5.0, 2.75 / 5.0, 1.0), fixed = True)
display.setVisibleShape(innerAntEB, shapes['Ring'](holeSize = 1.25/3.0))
display.setLabelPosition(innerAntEB, (0.0, 1.0 / 3.0, 0.0))
posteriorEB = network.createRegion(name = 'Posterior EB', abbreviation = 'Posterior', parentRegion = ellipsoidBody)
display.setArrangedAxis(posteriorEB, None)
display.setVisibleShape(posteriorEB, None)
display.setVisiblePosition(posteriorEB, (0.0, -0.3, 0.0), fixed = True)
display.setVisibleSize(posteriorEB, (1.3, 0.5, 0.75))
outerPostEB = network.createRegion(name = 'Ellipsoid body posterior outer ring', abbreviation = 'Outer', parentRegion = posteriorEB)
regions['EB-post-out'] = outerPostEB
display.setVisiblePosition(outerPostEB, (0.0, 0.0, 0.0), fixed = True)
display.setVisibleSize(outerPostEB, (1.0, 1.0, 1.0), fixed = True)
display.setVisibleShape(outerPostEB, shapes['Ring'](holeSize = 3.25 / 5.0))
display.setLabelPosition(outerPostEB, (0.0, -0.4, 0.0))
innerPostEB = network.createRegion(name = 'Ellipsoid body posterior inner ring', abbreviation = 'Inner', parentRegion = posteriorEB)
regions['EB-post-in'] = innerPostEB
display.setVisiblePosition(innerPostEB, (0.0, 0.0, 0.0), fixed = True)
display.setVisibleSize(innerPostEB, (2.75 / 5.0, 2.75 / 5.0, 1.0), fixed = True)
display.setVisibleShape(innerPostEB, shapes['Ring'](holeSize = 1.25/3.0))
display.setLabelPosition(innerPostEB, (0.0, -1.0 / 3.0, 0.0))
...
display.setLabel(noduli, noduli.name)
display.setLabelPosition(noduli, (0.0, 0.5, 0.0))
