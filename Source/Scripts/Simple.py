neuron1 = network.createNeuron(name = 'Neuron 1', neurotransmitters = [library.neurotransmitter('GABA')], function = NeuralFunction.SENSORY)
...
neuron4 = network.createNeuron(name = 'Neuron 4', neurotransmitters = [library.neurotransmitter('ACh')], function = NeuralFunction.MOTOR)
...
neuron5 = network.createNeuron(name = 'Neuron 5', neurotransmitters = [library.neurotransmitter('ACh')], function = NeuralFunction.MOTOR)
