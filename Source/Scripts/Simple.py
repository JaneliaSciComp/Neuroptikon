neuron1 = network.createNeuron('Neuron 1', neurotransmitter = library.neurotransmitter('GABA'))
...
neuron3 = network.createNeuron('Neuron 3', neurotransmitter = library.neurotransmitter('acetylcholine'))
