...
def connect(receiver, signal=Any, sender=Any, weak=True):
    ...
    if receiver is Any:
        raise errors.DispatcherTypeError(
            'The "Any" receiver has been disabled to improve performance (sender=%r)'%( sender)
        )
    if weak:
...
def getAllReceivers( sender = Any, signal = Any ):
    # This is not the original version of this method.  It was copied from 
    yielded = set()
    for receivers in (
...
# Disabling the following two because Neuroptikon doesn't use them and it improves performance.
