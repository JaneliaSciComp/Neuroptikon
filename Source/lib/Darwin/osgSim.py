...
class Impostor(osg.LOD):
    ...
    def setImpostorThresholdToBound(*args):
        """
        setImpostorThresholdToBound(self, float ratio=1.0f)
...
class LightPoint(_object):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, bool on, Vec3 position, Vec4 color, float intensity=1.0f, 
            float radius=1.0f, Sector sector=0, BlinkSequence blinkSequence=0, 
            BlendingMode blendingMode=BLENDED) -> LightPoint
        __init__(self, bool on, Vec3 position, Vec4 color, float intensity=1.0f, 
            float radius=1.0f, Sector sector=0, BlinkSequence blinkSequence=0) -> LightPoint
        __init__(self, bool on, Vec3 position, Vec4 color, float intensity=1.0f, 
            float radius=1.0f, Sector sector=0) -> LightPoint
        __init__(self, bool on, Vec3 position, Vec4 color, float intensity=1.0f, 
            float radius=1.0f) -> LightPoint
        __init__(self, bool on, Vec3 position, Vec4 color, float intensity=1.0f) -> LightPoint
...
class AzimRange(_object):
    ...
    def setAzimuthRange(*args):
        """
        setAzimuthRange(self, float minAzimuth, float maxAzimuth, float fadeAngle=0.0f)
...
class ElevationRange(_object):
    ...
    def setElevationRange(*args):
        """
        setElevationRange(self, float minElevation, float maxElevation, float fadeAngle=0.0f)
...
class AzimSector(Sector,AzimRange):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, float minAzimuth, float maxAzimuth, float fadeAngle=0.0f) -> AzimSector
...
class ElevationSector(Sector,ElevationRange):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, float minElevation, float maxElevation, float fadeAngle=0.0f) -> ElevationSector
...
class AzimElevationSector(Sector,AzimRange,ElevationRange):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, float minAzimuth, float maxAzimuth, float minElevation, 
            float maxElevation, float fadeAngle=0.0f) -> AzimElevationSector
        __init__(self, float minAzimuth, float maxAzimuth, float minElevation, 
...
class ConeSector(Sector):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, Vec3 axis, float angle, float fadeangle=0.0f) -> ConeSector
    ...
    def setAngle(*args):
        """
        setAngle(self, float angle, float fadeangle=0.0f)
...
class DirectionalSector(Sector):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, Vec3 direction, float horizLobeAngle, float vertLobeAngle, 
            float lobeRollAngle, float fadeAngle=0.0f) -> DirectionalSector
        __init__(self, Vec3 direction, float horizLobeAngle, float vertLobeAngle, 
