...
class TextBase(osg.Drawable):
    ...
    def setCharacterSize(*args):
        """
        setCharacterSize(self, float height, float aspectRatio=1.0f)
...
class Text(TextBase):
    ...
    def getBackdropImplementation(*args):
        """getBackdropImplementation(self) -> int"""
